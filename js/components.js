...
<header class="nav" id="nav">
  <div class="nav-inner">
    <a href="index.html" class="nav-logo">
      <span class="nav-logo-main">조성인 안경원</span>
...
<footer class="footer">
  <div class="footer-top">
    <div class="footer-top-in">
      <div>
        <p class="footer-brand-name">조성인 안경원</p>
  ...
  <div class="footer-bot">
    <p>&#169; 2026 조성인 안경원. All rights reserved.</p>
  </div>
</footer>`;
...
<div class="float-group" id="floatG">
  <a href="https://m.booking.naver.com/booking/13/bizes/819206/items/4948017?area=bmp&lang=ko&service-target=map-pc&startDate=2026-05-18&theme=place"
     target="_blank" class="float-main" title="예약하기">
    <span class="float-main-ico">&#9711;</span>
    <span class="float-main-lbl">예약</span>
  </a>
  <div class="float-subs">
    <a href="tel:05071439-0078" class="float-sub" title="전화문의">&#9742;</a>
    <a href="https://talk.naver.com/ct/w5uyll?frm=pblog#nafullscreen" target="_blank" class="float-sub" title="네이버톡">N</a>
    <a href="https://www.instagram.com/joseongin_glasses/" target="_blank" class="float-sub" title="인스타그램" style="font-size:.72rem;font-weight:900;">IG</a>
  </div>
</div>`;
...
<div class="modal" id="modal" onclick="if(event.target===this)closeModal()">
  <div class="modal-box">
    ...
    <div class="modal-hd">
      ...
      <h3>예약하기</h3>
      <p>원하시는 채널로 편리하게 예약하세요</p>
    </div>
    <div class="modal-opts">
      <a href="https://m.booking.naver.com/booking/13/bizes/819206/items/4948017?area=bmp&lang=ko&service-target=map-pc&startDate=2026-05-18&theme=place"
         target="_blank" class="modal-opt opt-naver">
        <div class="modal-opt-l">
          <span class="modal-opt-ico">&#9632;</span>
          <div><strong>네이버 예약</strong><small>날짜 선택 후 즉시 예약</small></div>
        </div><span class="modal-arr">&#8594;</span>
      </a>
      <a href="tel:05071439-0078" class="modal-opt opt-call">
        <div class="modal-opt-l">
          <span class="modal-opt-ico">&#9742;</span>
          <div><strong>전화 예약</strong><small>0507-1439-0078</small></div>
        </div><span class="modal-arr">&#8594;</span>
      </a>
      <a href="https://talk.naver.com/ct/w5uyll?frm=pblog#nafullscreen" target="_blank" class="modal-opt opt-talk">
        <div class="modal-opt-l">
          <span class="modal-opt-ico">&#9670;</span>
          <div><strong>네이버 톡톡</strong><small>채팅으로 편리하게 문의</small></div>
        </div><span class="modal-arr">&#8594;</span>
      </a>
      <a href="https://www.instagram.com/joseongin_glasses/" target="_blank" class="modal-opt opt-insta">
        <div class="modal-opt-l">
          <span class="modal-opt-ico">&#9673;</span>
          <div><strong>인스타그램 DM</strong><small>@joseongin_glasses</small></div>
        </div><span class="modal-arr">&#8594;</span>
      </a>
    </div>
    <div class="modal-foot">
      <p>대전 서구 둔산북로 22, 153&#183;154호 (둔산동 꽃시장 1층)</p>
